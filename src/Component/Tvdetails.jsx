...
const Tvdetails = ({id,closemodal}) => {
  ...
  return (
    <div className="fixed ml-0 top-0 left-0 w-full h-full z-50 flex items-center justify-center backdrop-blur-sm bg-black bg-opacity-50" onClick={closemodal} >
      <div className='relative text-black bg-white rounded-2xl h-[45%] w-[90%] md:h-[80%] md:w-[80%] '>
        ...
        {apidata && apidata.key ? (
          <div className=" w-full h-[80%] ">
            ...
            <div className='pl-2 md:pl-8'>
              ...
              <button className="md:px-8 px-4 py-1 md:py-7  bg-red-600 hover:bg-red-700 rounded-lg text-white text-sm md:text-3xl mt-3 md:mt-8" onClick={addfav}>Add to favorite</button>
            </div>
          </div>
