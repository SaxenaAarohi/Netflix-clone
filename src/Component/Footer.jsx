...
export default function Footer() {
  return (
    <footer className="bg-black text-gray-300 px-16 py-20">
      <div className="flex justify-center space-x-16 mb-14 text-7xl">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-10 text-4xl text-center md:text-left">
